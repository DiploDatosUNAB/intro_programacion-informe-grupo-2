...
En el informe hacemos hincapié en observar las variables de la edad de las víctimas, cuáles fueron las ciudades donde sucedió el secuestro, las ocupaciones de las victimas y los años de secuestro.
...
```{r}
victimas_parque <- select(parque_de_la_memoria, id, edad, fecha_de_secuestro, ano_en_monumento, lugar_de_secuestro, ocupaciones, sexo)
```
