...
Haremos hincapié en observar las variables que contienen la edad de las víctimas, cuáles fueron las ciudades y en qué años sucedieron los secuestros y asesinatos, las ocupaciones y espacios de militancia.
...
victimas_denuncia %>% 
  ...
  rename("Fecha de detención" = fecha_detencion_secuestro, "Lugar de detención" = lugar_detencion_secuestro, "Víctimas" = cantidad_fecha)
