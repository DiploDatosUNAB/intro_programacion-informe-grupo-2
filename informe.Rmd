...
Las fuentes principales de los datos del paquete provienen del Registro Único de Víctimas del Terrorismo de Estado (RUVTE) y del Monumento a las Víctimas del Terrorismo de Estado. 

En el informe haremos hincapié en observar las relaciones  (lo completamos cuando tengamos los graficos)
...
Exploro datos de victimas_parque
...
```
Exploro por ubicación del centro clandestino
```{r}
