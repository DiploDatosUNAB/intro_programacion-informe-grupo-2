...
militancias %>% 
  ...
  labs(fill = "Espacio de Militancia") +
  xlab("Espacio de Militancia") +
...
victimas_76_82 %>% 
  ...
  summarise(sum(cantidad_victimas))
```
Filtro Victimas del 76 al 82, agrupando por su edad y año.
...
Procedemos a visualizarlo mediante un gráfico, a través de los años del golpe cívico militar.
```{r}
ocupaciones %>% 
...
#ALbe, esto forma parte de la conclusión
```{r}
