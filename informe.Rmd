...
#Estaria bueno profundizar Tucuman
...
Queremos introducir la proporción de estudiantes sobre la cantidad total de víctimas
```{r}
ocupaciones %>% 
  group_by(ocupaciones) %>% 
  summarise(n = n()) %>% 
...
Procedemos a visualizarlo mediante un gráfico
```{r}
ocupaciones %>% 
