...
Haremos hincapié en observar las variables que contienen la edad de las víctimas, las ocupaciones y sus espacios de militancia, cuáles fueron las ciudades y en qué años sucedieron los secuestros y asesinatos.
...
DECIS QUE PONEMOS TODAS -porque son parte del paquete- O DEJAMOS SOLO LOS DATOS CON LOS QUE TRABAJAMOS?
```{r}
...
Exploramos las especificaciones de victimas_parque
```{r}
victimas_parque %>% 
  glimpse()
```
